from progTiroc.ai.main import check
import pytest
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__ge': 1}, {'a': 1},   not False),
    ({'a__ge': 1}, {'a': -1},  not True),
    ({'a__ge': 1}, {'a': 2},   not False),
    ({'a__ge': 1}, {'a': 1.4}, not False),
    ({'a__ge': 1}, {'a': 2.9}, not False),
    ({'a__ge': 4}, {'a': 2},   not True),
    ({'a__ge': 4}, {'a': 2.9}, not True),
])
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__gt': 1}, {'a': 1},   not True),
    ({'a__gt': 1}, {'a': -1},  not True),
    ({'a__gt': 1}, {'a': 2},   not False),
    ({'a__gt': 5}, {'a': 1.4}, not True),
    ({'a__gt': 5}, {'a': 5.1}, not False),
    ({'a__gt': 1}, {'a': 0},   not True),
])
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__ne': 1}, {'a': 1},   not True),
    ({'a__ne': 1}, {'a': -1},  not False),
    ({'a__ne': 1}, {'a': 1.0}, not True),
    ({'a__ne': 1}, {'a': 1.1}, not False),
    ({'a__ne': 5}, {'a': 5.1}, not False),
])
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__in': [1,2,3]}, {'a': 1},   True),
    ({'a__in': [1,2,3]}, {'a': -1},  False),
    ({'a__in': [1]},     {'a': 1.0}, True),
    ({'a__in': [-1.1]},  {'a': 1.1}, False),
])
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__nin': [1,2,3]}, {'a': 1},   not True),
    ({'a__nin': [1,2,3]}, {'a': -1},  not False),
    ({'a__nin': [1]},     {'a': 1.0}, not True),
    ({'a__nin': [-1.1]},  {'a': 1.1}, not False),
])
...
@pytest.mark.parametrize("condition,value,expected", [
    ({'a__lt': 1, 'a__gt': -1}, {'a': 0}, True),
    ({'a__gt': 1, 'a__lt':  2}, {'a': 1}, False),
    ({'a__ge': 1, 'a__lt':  2}, {'a': 1}, True),
